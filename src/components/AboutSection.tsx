...
const AboutSection: React.FC = () => {
  const experiences = [{
    ...
    description: 'Analyzed customer reviews using sentiment analysis and NLP techniques.'
  }, {
    company: 'BCG',
    position: 'Data Science & Analytics Intern',
    period: 'Virtual Experience',
    description: 'Developed predictive models for customer churn and provided strategic recommendations.'
  }, {
    company: 'Accenture',
    position: 'Data Analytics Intern',
    period: 'Virtual Experience',
    description: 'Processed and analyzed large datasets to identify operational efficiencies.'
  }];
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div>
            <div className="cyber-border p-1 overflow-hidden">
              <div className="w-full bg-cyber-darker p-5 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-base font-medium">Bachelor's in Computer Science</h4>
            ...
            <div className="cyber-border p-1 overflow-hidden mt-5">
              <div className="w-full bg-cyber-darker p-5 rounded-lg">
                <h3 className="text-lg font-medium mb-5 flex items-center">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-base font-medium">AWS Solution Architect</h4>
                    <p className="text-sm text-gray-400">Amazon Web Services</p>
                  </div>
                  <div>
                    <h4 className="text-base font-medium">Machine Learning Specialization</h4>
                    <p className="text-sm text-gray-400">Stanford University</p>
                  </div>
                  <div>
                    <h4 className="text-base font-medium">Data Science Professional</h4>
